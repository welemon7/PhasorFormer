...
def calculate_metrics_with_mask(img1, img2, mask):
    ...
    return {
        ...
        'mask': {'psnr': psnr_shadow, 'ssim': ssim_shadow, 'rmse': rmse_shadow},
    ...
    for filename in tqdm(common_files, desc="Evaluating images"):
        ...
        if mask is not None:
            ...
            metrics = {
                ...
                'mask': {'psnr': 0.0, 'ssim': 0.0, 'rmse': 0.0},
                'non_shadow': {'psnr': 0.0, 'ssim': 0.0, 'rmse': 0.0}
            }

        for region in ['full', 'mask', 'non_shadow']:
...
if __name__ == "__main__":
    if len(os.sys.argv) == 1:
        folder1 = r"D:\welemon2077\my_cv_storyCVPR\_2_SPL_PhasorFormer-Neurocomputing\PhasorFormer_result\PhasorFormer\ISTD+1"
        folder2 = r"D:\welemon2077\my_cv_storyCVPR\_0_deep learning\dataset\ISTD_Adjusted\test\non_shadow"
        mask_folder = r"D:\welemon2077\my_cv_storyCVPR\_0_deep learning\dataset\ISTD_Adjusted\test\mask"
